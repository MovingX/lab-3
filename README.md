...
<h2>Создание телеграмм бота</h2>
1.В телеграме в поиске вводим BotFather и создаём бота /newbot вводим обычное и уникальное имя бота, получим ссылку и токен<br>
2.Создаём папку проекта и инициализируем node.js командной npm init -y - создаётся package.json и внём пропишем:<br>
...
```
для того чтобы автоматически активировать нам скрипт<br>
3.Установим пакет для работы с телеграм ботом npm i node-telegram-bot api nodemon<br>
4.Создади файл script.js и приступим к написанию бота. Пример как может выглядеть бот:<br>

```js
const TelegramApi = require("node-telegram-bot-api");
const token = "6002796522:AAFpEg4ZVNsftwPC4hxyoHC9K4qo5mFwfc4";
...
```
<h2>Вывод</h2>
Я научился создавать веб-сервер с помощью Node.js и Express, создавать телеграмм бота, так же создавать некоторый интерактив с помощью скриптов и разметки html и понял логику работы js
